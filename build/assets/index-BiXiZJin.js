import { g as c, s as i, j as u } from "./index-XVuHETuZ.js";
var n = { exports: {} },
...
function a() {}
function p() {}
p.resetWarningCache = a;
var d = function () {
  function e(g, v, x, P, R, s) {
    if (s !== h) {
      var t = new Error(
...
`,
  f = (e) => u.jsx(b, { ...e, children: e.children });
f.propTypes = { children: T.node.isRequired };
export { T as P, f as S };
