  ...
  Ke = (e) => {
    ...
    return (
      ...
      ((typeof FormData == "function" && e instanceof FormData) ||
        (R(e.append) && ((t = H(e)) === "formdata" || (t === "object" && R(e.toString) && e.toString() === "[object FormData]"))))
    );
  },
...
function M(e, t, n) {
  ...
  const u = [],
    E = Object.assign(bt, { defaultVisitor: l, convertValue: h, isVisitable: G });
  function S(f, d) {
    if (!a.isUndefined(f)) {
...
const Pe = { silentJSONParsing: !0, forcedJSONParsing: !0, clarifyTimeoutError: !1 },
  Rt = typeof URLSearchParams < "u" ? URLSearchParams : Y,
  Ot = typeof FormData < "u" ? FormData : null,
  At = typeof Blob < "u" ? Blob : null,
  Tt = { isBrowser: !0, classes: { URLSearchParams: Rt, FormData: Ot, Blob: At }, protocols: ["http", "https", "file", "blob", "url", "data"] },
  ...
  Nt = Object.freeze(
    Object.defineProperty({ __proto__: null, hasBrowserEnv: Ce, hasStandardBrowserEnv: gt, hasStandardBrowserWebWorkerEnv: xt }, Symbol.toStringTag, {
      value: "Module",
    })
  ),
  O = { ...Nt, ...Tt };
  ...
  function t(n, r, s, o) {
    ...
    return (
      ...
      p
        ...
        : ((!s[i] || !a.isObject(s[i])) && (s[i] = []), t(n, r, s[i], o) && a.isArray(s[i]) && (s[i] = Ft(s[i])), !c)
    );
  }
...
`
          ...
          .forEach(function (i) {
            (s = i.indexOf(":")),
              ...
              !(!n || (t[n] && Bt[n])) && (n === "set-cookie" ? (t[n] ? t[n].push(r) : (t[n] = [r])) : (t[n] = t[n] ? t[n] + ", " + r : r));
          }),
      t
    );
  },
...
class z {
  ...
  set(t, n, r) {
    ...
    return (
      a.isPlainObject(t) || t instanceof this.constructor ? i(t, n) : a.isString(t) && (t = t.trim()) && !Ut(t) ? i(Dt(t), n) : t != null && o(n, t, r), this
    );
  }
  get(t, n) {
    if (((t = F(t)), t)) {
...
function le(e, t) {
  ...
  return (s) => {
    const o = s.loaded,
      ...
      h = o <= i;
    n = o;
    const l = { loaded: o, total: i, progress: i ? o / i : void 0, bytes: c, rate: p || void 0, estimated: p && i && h ? (i - o) / p : void 0, event: s };
  ...
  return (
    ...
    De.getAdapter(e.adapter || te.adapter)(e).then(
      ...
      function (r) {
        return (
          _e(r) ||
            (W(e), r && r.response && ((r.response.data = V.call(e, e.transformResponse, r.response)), (r.response.headers = T.from(r.response.headers)))),
          Promise.reject(r)
        );
      }
    )
...
ne.transitional = function (t, n, r) {
  ...
  return (o, i, c) => {
    ...
    return (
      n && !he[i] && ((he[i] = !0), console.warn(s(i, " has been deprecated since v" + n + " and will be removed in the near future"))), t ? t(o, i, c) : !0
    );
  };
};
function Gt(e, t, n) {
...
const v = { assertOptions: Gt, validators: ne },
  N = v.validators;
class j {
  constructor(t) {
    (this.defaults = t), (this.interceptors = { request: new ce(), response: new ce() });
  }
  async request(t, n) {
    try {
...
` + o)
  ...
  _request(t, n) {
    ...
    r !== void 0 &&
      v.assertOptions(
        r,
        { silentJSONParsing: N.transitional(N.boolean), forcedJSONParsing: N.transitional(N.boolean), clarifyTimeoutError: N.transitional(N.boolean) },
        !1
      ),
      s != null && (a.isFunction(s) ? (n.paramsSerializer = { serialize: s }) : v.assertOptions(s, { encode: N.function, serialize: N.function }, !0)),
...
a.forEach(["post", "put", "patch"], function (t) {
  function n(r) {
    return function (o, i, c) {
      return this.request(P(c || {}, { method: t, headers: r ? { "Content-Type": "multipart/form-data" } : {}, url: o, data: i }));
    };
  }
...
y.HttpStatusCode = Zt;
y.default = y;
const Yt = (e, t) => (!e || !t || e <= t ? 0 : Math.round(((e - t) / e) * 100));
export { y as a, Yt as c };
